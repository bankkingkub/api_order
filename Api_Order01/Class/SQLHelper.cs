...
namespace CarBrokerManagement.Class
{
    public class SQLHelper
    {
        private static string CONNECTION_STRING = @"Server=DESKTOP-5BTR7VG\RABIT;Database=Order_Food_db;User Id=sa;Password=123456789;MultipleActiveResultSets=true;";
